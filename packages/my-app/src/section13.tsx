    ...
    return (
        <Layout>
            <div class="section-contents">
                ...
                <h2>ダイアログ</h2>
                <button hx-get="/random" hx-confirm="ハロー">クリック</button>
                ...
                <button hx-get="/random" hx-push-url="true">クリック</button>

                <h2>hx-push-url(false)</h2>
                <button hx-get="/random" hx-push-url="false">クリック</button>
                ...
                <button hx-get="/random"
                    ...
                    hx-on-htmx-after-request="alert('こんばんは!')" >クリック</button>
