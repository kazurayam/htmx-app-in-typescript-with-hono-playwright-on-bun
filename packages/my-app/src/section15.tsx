        ...
        <Layout>
            <div class="section-contents">
                ...
                <div hx-ext="response-targets">
                    <button hx-get="/success" hx-target="#success" hx-target-404="#not-found" hx-target-5xx="#server-error">
                        ボタンA
                    </button>
                    <button hx-get="/not-found" hx-target="#success" hx-target-404="#not-found" hx-target-5xx="#server-error" >
                        ボタンB
                    </button >
                    <button hx-get="/server-error" hx-target="#success" hx-target-404="#not-found" hx-target-5xx="#server-error" >
                        ボタンC
                    </button >
